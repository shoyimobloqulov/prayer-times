...
var script6 = {
  ...
  methods: {
    ...
    onOptionChange: function onOptionChange2(event) {
      ...
      var root3 = isEmpty(processedOption.parent);
    ...
    createProcessedOptions: function createProcessedOptions(options2) {
      ...
      options2 && options2.forEach(function(option2, index) {
        ...
        newOption["children"] = _this13.createProcessedOptions(_this13.getOptionGroupChildren(option2, level), level + 1, newOption, key);
    ...
    "default": withCtx(function() {
      return [createVNode(Transition, mergeProps({
        ...
        "default": withCtx(function() {
          ...
          }, _objectSpread(_objectSpread(_objectSpread({}, _ctx.panelProps), _ctx.overlayProps), _ctx.ptm("overlay"))), [createBaseVNode("div", mergeProps({
